...
func TestBackupRoundTrip(t *testing.T) {
	...
	// --- Dump (custom format), all and data.
	...
	// --- Import: a plain SQL file is executed as-is.
...
func TestRestoreDryRunCommands(t *testing.T) {
	...
	assert.Contains(t, cmd, "ON_ERROR_STOP=off")
}
