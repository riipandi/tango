...
| Method | Endpoint                                              | Summary / Yaak Title                          | Status                                                 | Evidence |
| ------ | ----------------------------------------------------- | --------------------------------------------- | ------------------------------------------------------ | -------- |
| POST   | `/api/one-time-access-email`                          | Request one-time access email                 | done                                                   | `modules/identity/onetimeaccess` (parity tests pending) |
| POST   | `/api/one-time-access-token/{token}`                  | Exchange one-time access token                | done                                                   | `modules/identity/onetimeaccess` (parity tests pending) |
| POST   | `/api/signup`                                         | Sign up                                       | done                                                   | `modules/identity/signup` (parity tests pending) |
| GET    | `/api/signup-tokens`                                  | List signup tokens                            | done                                                   | `modules/identity/signup` (parity tests pending) |
| POST   | `/api/signup-tokens`                                  | Create signup token                           | done                                                   | `modules/identity/signup` (parity tests pending) |
| DELETE | `/api/signup-tokens/{id}`                             | Delete signup token                           | done                                                   | `modules/identity/signup` (parity tests pending) |
| POST   | `/api/signup/setup`                                   | Sign up initial admin user                    | done                                                   | `modules/identity/signup` (parity tests pending) |
...
| POST   | `/api/users/me/send-email-verification`               | Send email verification                       | done                                                   | `modules/identity/emailverification` (parity tests pending) |
| POST   | `/api/users/me/verify-email`                          | Verify email                                  | done                                                   | `modules/identity/emailverification` (parity tests pending) |
...
| POST   | `/api/users/{id}/one-time-access-email`               | Request one-time access email (admin)         | done                                                   | `modules/identity/onetimeaccess` (parity tests pending) |
| POST   | `/api/users/{id}/one-time-access-token`               | Create one-time access token for user (admin) | done                                                   | `modules/identity/onetimeaccess` (parity tests pending) |
...
| PUT    | `/api/users/{id}/user-groups`                         | Update user groups                            | done                                                   | `modules/identity/usergroup` (parity tests pending) |
